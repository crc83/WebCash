...
import com.siriusif.model.Permission;

/**
 * Backing bean for Permission entities.
 * <p>
 * This class provides CRUD functionality for all Permission entities. It focuses
...
public class PermissionBean implements Serializable
{
   ...
   public void retrieve()
   {
      ...
      {
         this.permission = findById(getId());
      }
   }
   ...
   public String update()
   {
      ...
      try
      {
         if (this.id == null)
         {
            this.entityManager.persist(this.permission);
            return "search?faces-redirect=true";
         }
         else
         {
            this.entityManager.merge(this.permission);
            return "view?faces-redirect=true&id=" + this.permission.getId();
         }
      }
      catch (Exception e)
      {
   ...
   public void paginate()
   {
      ...
      TypedQuery<Permission> query = this.entityManager.createQuery(criteria
   ...
   private Predicate[] getSearchPredicates(Root<Permission> root)
   {
   ...
   /*
    * Support listing and POSTing back Permission entities (e.g. from inside an
    * HtmlSelectOneMenu)
    */
   ...
   public List<Permission> getAll()
   {
      ...
      CriteriaQuery<Permission> criteria = this.entityManager
            .getCriteriaBuilder().createQuery(Permission.class);
      return this.entityManager.createQuery(
            criteria.select(criteria.from(Permission.class))).getResultList();
   }
