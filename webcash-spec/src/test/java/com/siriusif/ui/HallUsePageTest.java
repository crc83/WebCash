...
public class HallUsePageTest extends AbstractWebDriverTest{
	...
	/**
	 * given : I'm on a halls page
	 * when  : I click on table with opened orders
	 ...
	 */
	@Test
	public void testSelectTableFromFirstHall() throws FailingHttpStatusCodeException, MalformedURLException, IOException {
		get("");
		doLoginAsAdmin();
		browser.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		browser.findElement(ByXPath.xpath("//img[@onclick=\"location.href='orders_list.jsf?table=32768'\"]")).click();
